...
\newcommand{\ghb}{https://github.com/Sashkow/integrative-gene-expression-analysis/blob/article/imputation}
\newcommand{\src}[2]{\footnote{\url{\ghb/#1}~--- #2}}
...
\caption{Gene recovery and resulting missingness for each
  ...
  29.4\% of cells requiring imputation.\src{output/yehor_sashko/phase2b_1_2_yehor_6ds_no_37653_no_22490_enriched_sashko/imputed_gene_group_coverage.csv}{gene coverage data}\src{output/yehor_sashko/phase2b_1_2_yehor_6ds_no_37653_no_22490_enriched_sashko/summary.txt}{pipeline summary}}
\label{tab:recovery}
\end{table}
...
\caption{Per-group imputation safety audit for the 1\_2
  ...
  passed the both-groups-have-evidence rule.\src{output/yehor_sashko/phase2b_1_2_yehor_6ds_no_37653_no_22490_enriched_sashko/imputed_gene_group_coverage.csv}{per-gene coverage audit}}
\label{tab:coverage}
\end{table}
...
\caption{Block-structured missingness in the merged
  ...
  that an intersection-only analysis would miss.\src{articles/imputation_article/figures}{article figures}}
\label{fig:staircase}
\end{figure}
...
\caption{Leave-out cross-validation of \textit{softImpute}
  ...
  sparse for \texttt{biScale} to converge.\src{output/yehor_sashko/phase2b_1_2_yehor_6ds_no_37653_no_22490_enriched_sashko/imputation_validation.csv}{cross-validation results}}
...
\caption{PCA of batch-corrected expression matrices after
  ...
  genes recovered by imputation.\src{articles/imputation_article/figures/fig_pca_intersection.png}{intersection PCA}\src{articles/imputation_article/figures/fig_pca_softimpute.png}{softImpute PCA}}
\label{fig:pca}
\end{figure}
...
originally observed
genes.\src{scripts/integrative_analysis/article_validation/logfc_stability.R}{logFC stability script}\src{articles/imputation_article/data/logfc_stability/logfc_stability.csv}{per-gene logFC comparison data}
...
\caption{Differential expression counts for the 1\_2 comparison
  ...
  $|\text{logFC}| > 1$.\src{output/yehor_sashko/phase2b_1_2_yehor_6ds_no_37653_no_22490_enriched_sashko/method_comparison.csv}{DE method comparison data}}
\label{tab:de}
\end{table}
...
isolate the effect of sample
composition.\src{scripts/integrative_analysis/phase5_validation/config_validation_6ds.yaml}{validation config}\src{output/yehor_sashko/phase5_validation_6ds}{validation output}

\paragraph{Test~1: first-trimester subsampling.}
All 15 second-trimester samples were
retained\src{scripts/integrative_analysis/phase5_validation/test1_first_trim_subsample.R}{test~1 script}\src{output/yehor_sashko/phase5_validation_6ds/test1_first_trim_subsample.tsv}{test~1 results}
and the
...
list, we compared against a balanced 2-dataset
reference\src{scripts/integrative_analysis/phase5_validation/test1b_vs_balanced.R}{balanced comparison script}\src{output/yehor_sashko/phase5_validation_6ds/test1b_vs_balanced.tsv}{balanced comparison results}\src{output/yehor_sashko/phase2b_1_2_yehor_2ds_balanced/difexp_softimpute_combat.tsv}{balanced reference DE table}
...
The full sample was randomly
split\src{scripts/integrative_analysis/phase5_validation/test3_split_half.R}{split-half script}\src{output/yehor_sashko/phase5_validation_6ds/test3_split_half.tsv}{split-half results}
into two halves maintaining
...
\caption{Subsampling validation summary. \textbf{Left:}
  ...
  sample size.\src{output/yehor_sashko/phase5_validation_6ds/plots}{validation plots}\src{scripts/integrative_analysis/phase5_validation/plot_validation_results.R}{plot generation script}}
...
\caption{Direct-merge pipeline overview with parameter-dependent
  ...
  \texttt{de.imputed\_cell\_weight} $w = 0$ (hard masking).\src{scripts/integrative_analysis/phase2b_direct_merge/plot_na_staircase.R}{staircase visualisation code}}
\label{fig:pipeline}
\end{figure}
...
The pipeline
(\texttt{run\_phase2b.R}\src{scripts/integrative_analysis/phase2b_direct_merge/run_phase2b.R}{main pipeline script}\src{scripts/integrative_analysis/phase2b_direct_merge/config_yehor_sashko/config_phase2b_1_2_yehor_6ds_no_37653_no_22490_enriched_sashko.yaml}{6ds pipeline configuration})
consumes a YAML
...
Two imputation methods are
available\src{scripts/integrative_analysis/phase2b_direct_merge/imputation.R}{imputation methods implementation}:
\begin{enumerate}
...
batch-corrected\src{scripts/integrative_analysis/phase2b_direct_merge/normalization.R}{batch correction implementation}
with
