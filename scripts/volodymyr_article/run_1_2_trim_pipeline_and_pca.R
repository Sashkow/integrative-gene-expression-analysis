...
#' Run pipeline for 1st vs 2nd Trimester (5 datasets) and create PCA multiplot
#'
#' Datasets: GSE122214, GSE22490, GSE37901, GSE9984 (Affymetrix), GSE93520 (Agilent)
...
run_dataset_comparison(
  config_file = "config/volodymyr/config_volodymyr_1_2_trim.yaml",
  output_dir = "output/volodymyr/volodymyr_1_2_trim",
...
# The pipeline creates output in GSE93520 subfolder (baseline + GSE93520)
data_dir <- "output/volodymyr/volodymyr_1_2_trim/GSE93520"
