...
lykhenko_all <- read.csv("articles/imputation_article/data/lykhenko_2021/difexp_all_protein_coding.csv",
                         stringsAsFactors = FALSE)
lykhenko_sig <- read.csv("articles/imputation_article/data/lykhenko_2021/difexp_filtered_protein_coding.csv",
                         stringsAsFactors = FALSE)
