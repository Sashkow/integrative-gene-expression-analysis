...
pheno_path <- "data/mapped/yehor/8_yehor_preprocessed_datasets_enriched_sashko/phenodata_placenta_1_2_enriched_sashko.tsv"
output_dir <- "output/article_validation/combat_sensitivity"
